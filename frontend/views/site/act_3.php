...
<div id="container">
    <div class="wrap">
            ...
            <li class="breadcrumb-item active">PAGINA 3</li>
            </ol>
    ...
    <!-- actividade 1 -->
      ...
      <div class="row">
          <div class="col-lg-4">
            <a href="#">
            <img src="<?=Yii::$app->request->baseUrl?>/imgs/for_6.jpg" width="90%" class="imgs">
            </a>
          </div>
    ...
    <div class="col-md-3 col-md-offset-3" style="margin-left:500px;">
      ...
      <ul class="pagination">
        ...
        <li class="page-item">
          <a class="page-link" href="<?=Url::toRoute(['site/act_3'])?>">3</a>
        </li>
        <li class="page-item">
