...
<div class="container">
    <div class="wrap">
         ...
         <li class="breadcrumb-item active">ASSEMBLEIA GERAL</li>
         </ol>
           


            <ul class="topnav">
                    <li><a class="active" href="<?=Url::toRoute(['site/assembleia'])?>">ASSEMBLEIA GERAL</a></li>
            ...
            <div class="row">
                <div class="col-md-12">
                        ...
                        <h2><strong>DEFENIR ASSEMBLEIA GERAL</strong></h2>
                        </br>
            ...
            <div class="thumbnail">
                ...
                <div class="card-body">
                    ...
                    <h5 class="card-text">Elizabete Soares</h5>
                    </br>
                </div>
            ...
            <div class="col-md-4">
                <div class="thumbnail">
                    ...
                    <div class="card-body">
                        ...
                        <h5 class="card-text">Ana Ribeiro</h5>
                        </br>
                    </div>
         ...
         <div class="col-md-4">
            <div class="thumbnail">
                ...
                <div class="card-body">
                    ...
                    <h5 class="card-text">Francisco Souto Amado</h5>
                    </br>
                </div>
